  ...
  render() {
    return (
      <svg
        ...
        width={getArcWidth(this.props.dimension) * 0.92}
        x={getSunIconX(this.props) - getDimension(this.props) / 28}
        y={getSunIconY(this.props) - getDimension(this.props) / 2.07}
        overflow="visible"
      >
        <g
          transform={`translate(${-0.5 *
            getArcWidth(this.props.dimension)}, ${-0.5 *
            getArcWidth(this.props.dimension)})`}
        >
          <path
